...
namespace ClearData.Services
{
    public class PermissionsDataStore
    {
        ...
        public PermissionsDataStore()
        {
            ...
            {
                new DataType { Id = 1, Name = "Coarse Location Data", Description = "General location data tracking your rough location such as your current suburb", Enabled = false},
                new DataType { Id = 2, Name = "Fine Location Data", Description = "GPS location data tracking your specific position, usually accurate to within 5 metres", Enabled = false },
                new DataType { Id = 3, Name = "Browsing Data", Description = "Browsing history tracking what websites you visit", Enabled = false },
            };
            ...
            Company Google = new Company
            {
                ...
                WantedDataTypes = new SortedSet<int> { 1, 3 },
            };
            ...
            Company Amazon = new Company
            {
                ...
                Restriction = Company.RestrictionType.ALL,
                WantedDataTypes = new SortedSet<int> { 2, 3 },
            };
